package net.robin.onlineshopping.handler;
...
import net.robin.onlineshopping.model.CheckoutModel;
import net.robin.onlineshopping.model.UserModel;
import net.robin.shoppingbackend.dao.CartLineDAO;
import net.robin.shoppingbackend.dao.ProductDAO;
import net.robin.shoppingbackend.dao.UserDAO;
...
import net.robin.shoppingbackend.dto.OrderItem;
